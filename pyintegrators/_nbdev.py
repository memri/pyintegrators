...
index = {"read_file": "basic.ipynb",
         ...
         "FaceClusteringModel": "indexers.FaceClusteringIndexer.Models.ipynb",
         "confidence2clusters": "indexers.FaceClusteringIndexer.Utils.ipynb",
         "group_clusters": "indexers.FaceClusteringIndexer.Utils.ipynb",
         ...
         "l2norm": "indexers.FaceClusteringIndexer.Utils.ipynb",
         "knn_faiss": "indexers.FaceClusteringIndexer.Utils.ipynb",
         "FaceClusteringIndexer": "indexers.FaceClusteringIndexer.indexer.ipynb",
         "arcface_r100_v1": "indexers.FaceRecognitionModel.ipynb",
         "retinaface_r50_v1": "indexers.FaceRecognitionModel.ipynb",
         "RETINAFACE_URL": "indexers.FaceRecognitionModel.ipynb",
         "ARCFACE_URL": "indexers.FaceRecognitionModel.ipynb",
         "FaceEmbeddingModel": "indexers.FaceRecognitionModel.ipynb",
...
modules = ["data/basic.py",
           ...
           "indexers/facerecognition/model.py",
...
doc_url = "http://memri.docs.memri.io/pyintegrators/"

git_url = "https://gitlab.memri.io/memri/pyintegrators/tree/prod/"
