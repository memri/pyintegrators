...
index = {"read_file": "basic.ipynb",
         ...
         "get_g_attr": "importers.WhatsAppImporter.ipynb",
         "EmailImporter": "importers.EmailImporter.ipynb",
         "ImporterBase": "importers.Importer.ipynb",
         "Matrix": "importers.MatrixClient.ipynb",
         "MatrixClient": "importers.MatrixClient.ipynb",
         "get_random_alphanumeric_string": "importers.WhatsAppImporter.ipynb",
         "MautrixWhatsapp": "importers.WhatsAppImporter.ipynb",
         "WhatsAppImporter": "importers.WhatsAppImporter.ipynb",
