...
index = {"read_file": "basic.ipynb",
         ...
         "create_external_id": "importers.EmailImporter.ipynb",
         "split_external_id": "importers.EmailImporter.ipynb",
         "get_external_ids_in_namespace": "importers.EmailImporter.ipynb",
