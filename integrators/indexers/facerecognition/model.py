# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/indexers.FaceRecognition.Models.ipynb (unless otherwise specified).

__all__ = ['arcface_r100_v1_old', 'arcface_r100_v1', 'retinaface_r50_v1', 'RETINAFACE_URL', 'ARCFACE_URL',
           'ARCFACE_URL_2', 'FaceEmbeddingModel']
...
ARCFACE_URL_2    = f"{MEMRI_S3}/arcface_r100_v1.pth"


def arcface_r100_v1_old():
...
def arcface_r100_v1():
    file = MODEL_DIR / "arcface_r100_v1.pth"
    download_file(ARCFACE_URL_2, file)
    model = ArcFaceModel()
...
class FaceEmbeddingModel():
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.recognition_model_old = arcface_r100_v1_old()
        self.recognition_model_old.prepare(-1);
